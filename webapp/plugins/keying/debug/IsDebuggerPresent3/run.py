def desc():
    return "IsDebuggerPresent Weird API call"
...
'''
    keying = '''\
	if (((PEB*)(__readgsqword(0x60)))->NtGlobalFlag == (FLG_HEAP_ENABLE_TAIL_CHECK | FLG_HEAP_ENABLE_FREE_CHECK | FLG_HEAP_VALIDATE_PARAMETERS))
		SafeEnv = FALSE;\
'''
